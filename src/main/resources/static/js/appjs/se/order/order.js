...
function load() {
    ...
    tableGrid = $("#table_list").jqGrid({
        ...
        colModel: [
            ...
            { name:'expenseFee', index:'expenseFee', editable:true, width:70, align:"right", sorttype:"float", formatter:"number" },
            ...
            { name:'remark', index:'remark', editable:true, sorttype:"text", width:70 },
