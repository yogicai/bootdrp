...
function load() {
    ...
    tableGrid = $("#table_list").jqGrid({
        ...
        rowNum: 20,
        rowList: [20, 50, 100],
        colNames: ['单据日期', '编号', '类型', '销售人员', '客户', '数量', '商品金额', '优惠率', '优惠金额', '采购费用', '已付金额', '优惠后商品金额', '客户承担金额', '合计金额', '状态', '审核状态', '结算帐户', '备注', '更新时间'],
        colModel: [
            ...
            { name:'billerName', index:'billerName', editable:true, sorttype:"text", width:90 },
            ...
            { name:'expenseFee', index:'expenseFee', editable:true, width:80, align:"right", sorttype:"float", formatter:"number" },
