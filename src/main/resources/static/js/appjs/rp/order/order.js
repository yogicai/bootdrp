...
function load() {
    ...
    tableGrid = $("#table_list").jqGrid({
        ...
        colModel: [
            ...
            { name:'discountAmount', index:'discountAmount', editable:true, width:60, align:"right", sorttype:"float", formatter:"number" },
            { name:'checkName', index:'checkName', editable:true, sorttype:"text", width:60 },
            { name:'auditStatus', index:'auditStatus', editable:true, sorttype:"text", width:60, formatter:function (cellValue){return utils.formatEnumS(cellValue, 'AUDIT_STATUS')} },
