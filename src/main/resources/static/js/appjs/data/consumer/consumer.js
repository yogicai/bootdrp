...
$(function () {
    ...
    utils.loadCategory(["CUSTOMER"], ["type"], [{width: "120px"}]);
    ...
    $exampleTable.bootstrapTable(
        {
            ...
            columns: [
                ...
                {field: 'no', title: '编号'},
                {field: 'name', title: '名称'},
                {field: 'type', title: '客户类别', formatter: (value, row, index) => utils.formatCategory(value, "CUSTOMER")},
                {field: 'grade', title: '客户等级', formatter: (value, row, index) => utils.formatType(value, "data_grade")},
