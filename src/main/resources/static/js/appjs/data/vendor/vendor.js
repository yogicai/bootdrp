...
$(function () {
    ...
    utils.loadCategory(["VENDOR"], ["type"], [{width: "120px"}]);
    ...
    $exampleTable.bootstrapTable(
        {
            ...
            columns: [
                ...
                {title: '供应商类别', field: 'type', formatter: (value, row, index) => utils.formatCategory(value, "VENDOR")},
                {title: '联系人', field: 'contacts'},
                {title: '联系人电话', field: 'phone'},
                {title: '供应商地址', field: 'address'},
                {title: '店铺', field: 'shopNo', formatter: (value, row, index) => utils.formatType(value, "data_shop")},
                {title: '状态', field: 'status', formatter: utils.formatYN},
