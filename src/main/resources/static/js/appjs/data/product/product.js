						...
						columns : [
								{
									...
									formatter : function (value,row,index){
										return utils.formatCategory(value, "PRODUCT")
									}
								},
																{
									field : 'brand', 
									title : '品牌' ,
									formatter : function (value,row,index){
										return utils.formatType(value, "data_brand")
									}
								},
																{
									field : 'unit', 
									title : '单位',
									formatter : function (value,row,index){
										return utils.formatType(value, "data_unit")
									}
								},
																{
									field : 'purchasePrice', 
                                    ...
                                    title : '首选仓库',
                                    formatter : function (value,row,index) {
                                        return utils.formatType(value, "data_stock")
                                    }
                                },
																{
									field : 'status', 
									title : '状态',
                                    formatter : utils.formatYN
								},
																{
									field : 'createTime', 
									title : '创建时间' 
