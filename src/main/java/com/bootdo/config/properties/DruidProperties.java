...
public class DruidProperties {
     ...
     * mysql校验语句
     */
    private static final String MYSQL_VALIDATE_QUERY_SQL = "select 1";

    /**
     * oracle校验语句
     */
    private static final String ORACLE_VALIDATE_QUERY_SQL = "select 1 from dual";

    /**
     * postgresql校验语句
     */
    private static final String POSTGRESQL_VALIDATE_QUERY_SQL = "select version()";

    /**
     * sqlserver校验语句
     */
    private static final String SQLSERVER_VALIDATE_QUERY_SQL = "select 1";

    /**
     * 达梦数据库校验语句
     */
    private static final String DM_VALIDATE_QUERY_SQL = "select 1";

    /**
     * 人大金仓数据库校验语句
     */
    private static final String KINGBASEES_VALIDATE_QUERY_SQL = "select 1";
