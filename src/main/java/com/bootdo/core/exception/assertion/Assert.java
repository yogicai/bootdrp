package com.bootdo.core.exception.assertion;
...
public interface Assert {
     ...
     * @return 业务异常
     */
    RuntimeException newException(Throwable t, Object... args);

    /**
     * 创建异常.
     * 先使用 {@code errMsg} 创建一个 {@link RuntimeException} 异常,
    ...
    /**
     * 创建异常.
     * 先使用 {@code errMsg} 和 {@code t} 创建一个 {@link RuntimeException} 异常,
     * 再以入参的形式传给 {{{@link #newException(Throwable, Object...)}}}, 作为最后创建的异常的 cause 属性.
     *
     * @param errMsg 自定义的错误信息
     * @param t 异常
    ...
    default RuntimeException newExceptionWithMsg(String errMsg, Throwable t, Object... args) {
        ...
        RuntimeException e = new RuntimeException(errMsg, t);
        throw newException(e, args);
    }
